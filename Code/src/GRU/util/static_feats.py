...
hourly = ["_pMean", "_PAP", "_Delta PO2", "_LA Ca++", "_LA PCO2", "_LA HCO3", "_STEEN lost", "_LAP", "_Calc Delta PCO2", "_LA BE", "_LA K+", "_pPlat", 
          "_LA CL", "_Cstat", "_Cdyn", "_PA PCO2", "_LA Na+", "_LA Lact", "_LA Glu", "_pPeak", "_LA pH", "_LA PO2", "_PA PO2"]
per_hour = ["tv_"]
