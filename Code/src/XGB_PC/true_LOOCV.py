...
from xgboost import XGBRegressor
import os
feat_dir = '../../../Model/XGB_PC/results_true_hyper'
save_dir = '../../../Model/XGB_PC/results_true_LOOCV'
os.makedirs(save_dir, exist_ok=True)

# Data Merging
tab_data_df = pd.read_csv('df_real1h2h.csv', index_col='Evlp Id No')
...
selected_hypers = pd.read_csv('../../../Model/XGB_PC/results_true_hyper/results04.csv')
